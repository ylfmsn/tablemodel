...
import com.suntoon.swing.table.editor.JSTableColorEditor;
import com.suntoon.swing.table.header.JSTableHeaderCheckboxRenderer;
import com.suntoon.swing.table.renderer.JSTableCheckboxRenderer;
import com.suntoon.swing.table.renderer.JSTableColorRenderer;
...
public class JFrameDefaultTableDemo extends JFrame {
    ...
    private void initCompents() {
        ...
        col0.setIdentifier(TestEnum.ATTR_ID_COL.getCode());      // id
        col0.setTitle(TestEnum.ATTR_ID_COL.getDesc());
        col0.setHeaderValue(TestEnum.ATTR_ID_COL.getDesc());
        ...
        col1.setIdentifier(TestEnum.ATTR_NAME_COL.getCode()); // 对应的实体字段
        col1.setTitle(TestEnum.ATTR_NAME_COL.getDesc());
        col1.setHeaderValue(TestEnum.ATTR_NAME_COL.getDesc());
        ...
        col2.setIdentifier(TestEnum.ATTR_TYPE_COL.getCode());
        col2.setTitle(TestEnum.ATTR_TYPE_COL.getDesc());
        col2.setHeaderValue(TestEnum.ATTR_TYPE_COL.getDesc());
        ...
        col3.setIdentifier(TestEnum.ATTR_LENGTH_COL.getCode());
        col3.setTitle(TestEnum.ATTR_LENGTH_COL.getDesc());
        col3.setHeaderValue(TestEnum.ATTR_LENGTH_COL.getDesc());
        ...
        col4.setIdentifier(TestEnum.ATTR_PREC_COL.getCode());
        col4.setTitle(TestEnum.ATTR_PREC_COL.getDesc());
        col4.setHeaderValue(TestEnum.ATTR_PREC_COL.getDesc());
        ...
        col5.setIdentifier(TestEnum.ATTR_INPUT_TYPE_COL.getCode());
        col5.setTitle(TestEnum.ATTR_INPUT_TYPE_COL.getDesc());
        col5.setHeaderValue(TestEnum.ATTR_INPUT_TYPE_COL.getDesc());
        col5.setModelIndex(5);
        col5.setWidth(110);
        col5.setDefaultValue("手写");
        col5.setCellRenderer(new JSTableColorRenderer());
        col5.setCellEditor(new JSTableColorEditor());

        // 别名
        // 系统默认的渲染器和编辑器
        JSTableColumn col6 = new JSTableColumn();
        col6.setIdentifier(TestEnum.ATTR_ALIAS_COL.getCode()); // 对应的实体字段
        col6.setTitle(TestEnum.ATTR_ALIAS_COL.getDesc());
        col6.setHeaderValue(TestEnum.ATTR_ALIAS_COL.getDesc());
        ...
        col7.setIdentifier(TestEnum.ATTR_SHOW_COL.getCode());
        col7.setTitle(TestEnum.ATTR_SHOW_COL.getDesc());
        col7.setHeaderValue(TestEnum.ATTR_SHOW_COL.getDesc());
        ...
        col8.setIdentifier(TestEnum.ATTR_KEY_COL.getCode());
        col8.setTitle(TestEnum.ATTR_KEY_COL.getDesc());
        col8.setHeaderValue(TestEnum.ATTR_KEY_COL.getDesc());
        ...
        col9.setIdentifier(TestEnum.ATTR_DEFAULT_COL.getCode()); // 对应的实体字段
        col9.setTitle(TestEnum.ATTR_DEFAULT_COL.getDesc());
        col9.setHeaderValue(TestEnum.ATTR_DEFAULT_COL.getDesc());
        ...
        col10.setIdentifier(TestEnum.ATTR_FORMULA_COL.getCode()); // 对应的实体字段
        col10.setTitle(TestEnum.ATTR_FORMULA_COL.getDesc());
        col10.setHeaderValue(TestEnum.ATTR_FORMULA_COL.getDesc());
